      ...
      <div className="py-8 grid grid-cols-1 md:grid-cols-2 gap-5">
        <>
          <GlowCard identifier="repos-per-language">
            <Image
              src={`https://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=${personalData.githubUser}&theme=algolia`}
              width={1080}
              height={560}
          ...
          <GlowCard identifier="most-commit-language">
            <Image
              src={`https://github-profile-summary-cards.vercel.app/api/cards/most-commit-language?username=${personalData.githubUser}&theme=algolia`}
              width={1080}
              height={560}
